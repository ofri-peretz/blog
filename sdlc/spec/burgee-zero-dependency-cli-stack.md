...
| like-for-like: burgee's six drop-ins still install all nine (article: "burgee still installs all nine") | 9                                                                                                                                                                                                                                                    | `npm i --package-lock-only burgee@0.10.0 roundel@0.4.3 flagstaff@0.3.7 caique@0.4.3 linegauge@0.4.4 closeout@0.4.1` then count `node_modules/` keys (burgee pulls seniority and bellpull, flagstaff pulls paratext)                                                | versions above                                  | 2026-09-23           |
...
| seniority parses no YAML                                                                                | JSON subset only                                                                                                                                                                                                                                     | `git -C burgee show 7fb62c2:packages/seniority/src/cosmiconfig-defaults.ts` lines 9-15 and `loadYaml`; the published 0.4.3 dist carries the same refusal                                                                                                           | seniority 0.4.3                                 | 2026-09-23           |
| engine depends on five siblings; six of nine declare none                                               | 5; 6                                                                                                                                                                                                                                                 | `npm view <pkg>@<ver> dependencies --json` for each of the nine at the pinned versions (burgee@0.10.0, roundel@0.4.3, flagstaff@0.3.7, caique@0.4.3, linegauge@0.4.4, seniority@0.4.3, bellpull@0.2.3, closeout@0.4.1, paratext@0.5.4)                             | versions above                                  | 2026-09-23           |
...
| versions named in the article (burgee 0.10.0, cosmiconfig 10.0.1)                                       | 0.10.0 / 10.0.1                                                                                                                                                                                                                                      | `npm view burgee version`, `npm view cosmiconfig version`, and the resolved lists in `out/family-all9.json`, `out/stack-commander.json`                                                                                                                            | registry                                        | 2026-09-23 07:30 UTC |
...
| bundle re-runs are insensitive to the 07:02-07:10 patch wave                                            | 27,815 / 59,421 B, identical before and after                                                                                                                                                                                                        | `node bundle.mjs` in the scratch directory installed at about 06:05 (roundel 0.4.2, closeout 0.4.0, linegauge 0.4.3) and by two reviewers on fresh installs of the 07:16 set                                                                                       | burgee 0.10.0                                   | 2026-09-23           |
...
| family declares Node 24                                                                                 | >=24                                                                                                                                                                                                                                                 | `npm view <pkg>@<ver> engines` for each of the nine at the pinned versions                                                                                                                                                                                         | versions above                                  | 2026-09-23           |
...
The ETARGET poll log, verbatim (one line per `npm i --package-lock-only burgee` attempt, UTC). The one-off probe before it printed `date -u` as 05:39:31 beside `npm error notarget No matching version found for closeout@^0.4.0`.
