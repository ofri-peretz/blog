...
re-run read worse than burgee's published figure.
...
| burgee family installed together (article: 9 pkgs, 1,577 KB)                              | 9 / 1,614,853 B                                                                                                                                                                                                                                      | `node measure.mjs family-all9 burgee roundel flagstaff caique linegauge seniority bellpull closeout paratext`                                                                                                               | versions above                                  | 2026-09-23 |
...
| the three unmet gates' target (article: ≤ 1.0×)                                           | <= 1                                                                                                                                                                                                                                                 | `git -C burgee show origin/main:benchmarks/results/cli-benchmarks/2026-09-22-fd0f6b2.json`, `claims.<gate>.target`                                                                                                          | burgee 7fb62c2                                  | 2026-09-23 |
