...
| versions named in the article (burgee 0.10.0, cosmiconfig 10.0.1)                         | 0.10.0 / 10.0.1                                                                                                                                                                                                                                      | `npm view burgee version`, `npm view cosmiconfig version`, and the resolved lists in `out/family-all9.json`, `out/stack-commander.json`                                                                                                                            | registry                                        | 2026-09-23 |
