...
| `require('burgee/commander')` runs on Node 24 (count, `--json`)      | 6 lines in sample.txt        | `node sdlc/spec/burgee-change-one-import.repro.mjs cjs-require`                                                                                                                                                                                                 | burgee 0.9.2, Node 24.18.0     | 2026-09-23 |
