...
quality:
  panel_version: "1.0.0"
  reviewed: "2026-09-04"
  spec: sdlc/spec/eslint-plugin-dependency-weight.md
  lenses:
    growth_hook: 9.6
...
I am not the leanest here and I want to be precise about that: **`eslint-plugin-promise` adds one package and I add two.** If dependency weight is your only axis, promise is the leaner choice.
