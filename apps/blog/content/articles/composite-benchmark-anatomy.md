...
| Unmeasurable dimension?         | Null, never imputed; harness renormalizes over measured dims — *n*-of-7 label lives at the claims layer (this run: 7-of-7) |
...
*What's the largest weight you'd assign differently in that table — and which dimension would you demote to pay for it?*
