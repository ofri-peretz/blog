  ...
  return (
    <div
      ...
      className={cn(
        ...
        // Dark mode: a warm brand wash rather than the inherited purple
        "dark:from-neutral-950 dark:via-brand-orange/8 dark:to-neutral-900",
        containerClassName,
      )}
    ...
    <>
      ...
      <motion.div
        ...
        className={cn(
          ...
          // Brand beam. No dark: variant needed — --brand-* already resolves
          // per theme, so one class covers both.
          "bg-gradient-to-t from-brand-orange via-brand-green to-transparent",
      ...
      {spans.map((span) => (
        <motion.span
          ...
          className={cn(
            ...
            "bg-gradient-to-b from-brand-orange to-brand-green",
          )}
        />
      ))}
    </div>
