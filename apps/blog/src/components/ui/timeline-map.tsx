...
// ink budget from #58, the filter focus-trap fix from #59, and the
// number-axis mode from #61). Copy-with-provenance until the registry
// install path replaces it — fix bugs upstream first, then re-vendor.
// Local deltas: the `cn` import path only.
