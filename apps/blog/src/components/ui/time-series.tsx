...
// fixes, interlace#44; weave-reveal motion contract, interlace#77;
// two-point range comparison, interlace#80; anchor stays visible
// after the pointer leaves + Space documented, interlace#81).
...
import { Delta, type Polarity } from './delta';
