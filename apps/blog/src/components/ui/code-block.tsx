...
// onCopied measurement seam, interlace#68). Copy-with-provenance
// until the registry install path replaces it — fix bugs upstream
// first, then re-vendor. Local deltas: the `cn` import path and
