...
// packages/ui/src/charts/delta.tsx — visualization layer, interlace#42;
// range comparison for TimeSeries, interlace#80).
...
import { delta as computeDelta, type Direction, type Point } from './scale';
