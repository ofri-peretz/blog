 ...
 */
// Defaults resolve via CSS tokens defined in app `globals.css`. Consumers
// override per-theme by redefining `--beam-from` / `--beam-to`; the rule
// no-raw-color-literal is satisfied because nothing here is a literal hex.
