'use client';
// @interlace/dropdown-menu v1.2.0 — Interlace design system.
// Docs, props and live preview: https://ds.interlace.tools/c/dropdown-menu
// What changed since: https://ds.interlace.tools/c/dropdown-menu#history
