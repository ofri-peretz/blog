'use client';
// @interlace/checkbox v1.1.0 — Interlace design system.
// Docs, props and live preview: https://ds.interlace.tools/c/checkbox
// What changed since: https://ds.interlace.tools/c/checkbox#history
